...
function Home(props) {
  ...
  let description =
      "I am a passionate fullstack developer. I like coding, playing video games, learning etc. I am not a good writer but I'm pretty good at coding. I am always hungry to learn useful things and improve myself. I am looking to obtain a position that will allow me utilize my technical skills, experience and willingness to learn in making an organization successful.",
    p = true
  useEffect(() => {
